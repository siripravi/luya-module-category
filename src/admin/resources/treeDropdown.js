...
zaa.directive("treeDropdown", ['$compile', function ($compile,$sanitize) {
        ...
        function getOptions(scope, items, level) {
            ...
            angular.forEach(items, function (obj){
                ...
                var someHtml = "<input checked='checked' id='menu"+obj.key+"' type='checkbox'><span class='tree_label' for='menu"+obj.key+"'><a>" + obj.title + "</a></span>";
        ...
        return {
            ...
            controller: ['$scope', '$http', function ($scope, $http) {
                    ...
                    $scope.getTreeData = function (id) {                        
                        $http.get('admin/api-categorytree-category/tree?id=' + id).then(function (r) {
                            $scope.items = r.data;
                        });
                    };

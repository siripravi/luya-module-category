...
class ToggleStatus extends Plugin
{
    ...
    public function renderList($id, $ngModel)
    {
        ...
        return [
            ...
            $this->createTag('i', $this->falseIcon, ['style' => 'cursor:pointer;', 'ng-if' => "$ngModel == $this->falseValue", 'class' => $this->falseClass,]),
        ];
    }
    ...
    {
        return $this->createFormTag('temp-checkbox', $id, $ngModel, ['options' => json_encode(['true-value' => $this->trueValue, 'false-value' => $this->falseValue]), 'initvalue' => $this->initValue]);
    }

...
class Category extends NgRestModel
{
    ...
    public function ngrestExtraAttributeTypes()
    {
        return [
            'position' => [
                // 'class' => \siripravi\category\admin\admin\plugins\RadioList::class(),
                'selectArray',
                'data' => [
            ...
            'related' => ['class' => \siripravi\category\admin\plugins\TreePlugin::class],
            'selected' => ['class' => \siripravi\category\admin\plugins\TreeSelectPlugin::class],
